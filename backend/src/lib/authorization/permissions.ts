...
export const SYSTEM_PERMISSIONS: PermissionDefinition[] = [
  ...
  { code: 'maps.manage', resource: 'maps', action: 'manage', label: 'Gestisci Mappe', description: 'Gestire le coordinate delle sedi e i link mappa pubblici.', isSystem: true },
  ...
  { code: 'maintenance.manage', resource: 'maintenance', action: 'manage', label: 'Gestisci Manutenzione', description: 'Attivare la manutenzione delle pagine pubbliche e modificarne i messaggi.', isSystem: true },
